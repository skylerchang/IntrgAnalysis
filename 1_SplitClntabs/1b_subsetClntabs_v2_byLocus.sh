...
echo "Looking for clntab files..."
#get 1st subdirectory in directory
d1="$(ls $1/Data/Clntab/* | head -1)"; d2=${d1/:/}
echo "d1: "$d1
#get first file in directory
f1="$(ls $d2/* | head -1)"
echo "f1: "$f1
echo "d2: "$d2
echo "Clntab files found"
...
sed '1q;d' $f1 > $1/Results/Clntab/clntab_header.txt
sed '1q;d' $f1 | tr '\t' $'\n' > $1/Results/Clntab/clntab_header_transposed.txt

#========= check numbers in original clntab file =================
echo "producing stats ..."

#get counts for original clntab file
touch $1/Results/Clntab/clntab-unireads.txt
touch $1/Results/Clntab/clntab-reads.txt
echo "Counting lines in original clntab files ..."
for dir in $1/Data/Clntab/*
do
	echo "dir: "$dir
	fname=`basename $dir`; echo $fname; 
	wc -l $dir/${fname}.clntab >> $1/Results/Clntab/clntab-unireads.txt; 
	awk -F'\t' -v c1=$colSize '{total = total + $c1}END{print total, FILENAME}' $dir/${fname}.clntab >> $1/Results/Clntab/clntab-reads.txt; 
done
...
do
	...
	do 
		echo $locus
		if [ "$locus" = "noju" ]; then 
			grep 'noju' $f1 > $1/Data/Clntab/$base/${base}_${locus}.clntab;
		else
			target=$locus"J"
			grep -v 'noju' $f1 | grep $target > $1/Data/Clntab/$base/${base}_${locus}.clntab;
		fi
	done
done
...
do
	...
	do 
		...
		wc -l $dir/${fname}_${locus}.clntab | sed 's/^ *//g' >> $1/Results/Clntab/clntab_$locus-unireads.txt
		#output the sum of all lines of col 27 (sequence.size) => to calculate total read number
		awk -F'\t' -v c1=$colSize '{total = total + $c1}END{print total, FILENAME}' $dir/${fname}_${locus}.clntab >> $1/Results/Clntab/clntab_$locus-reads.txt; 
		#if sum equals zero, i.e. does not exist, insert '0'
		sed 's/^ /0 /g' $1/Results/Clntab/clntab_$locus-reads.txt > tmpfile; mv tmpfile $1/Results/Clntab/clntab_$locus-reads.txt
	done
done

#summarize uniread counts
echo "Unireads cross-check: cols: IGH TRA TRB TRD TRG noju sum all sum-all; col9 should equal 0"
echo "IGH TRA TRB TRD TRG noju sum all sumMinusAll sample" > $1/Results/Clntab/clntab_ALL-unireads.txt;
paste $1/Results/Clntab/clntab_IGH-unireads.txt $1/Results/Clntab/clntab_TRA-unireads.txt $1/Results/Clntab/clntab_TRB-unireads.txt $1/Results/Clntab/clntab_TRD-unireads.txt $1/Results/Clntab/clntab_TRG-unireads.txt $1/Results/Clntab/clntab_noju-unireads.txt $1/Results/Clntab/clntab-unireads.txt | awk '{print $1,$3,$5,$7,$9,$11, ($1+$3+$5+$7+$9+$11), ($13-1), ($1+$3+$5+$7+$9+$11-$13+1), $14}' 
paste $1/Results/Clntab/clntab_IGH-unireads.txt $1/Results/Clntab/clntab_TRA-unireads.txt $1/Results/Clntab/clntab_TRB-unireads.txt $1/Results/Clntab/clntab_TRD-unireads.txt $1/Results/Clntab/clntab_TRG-unireads.txt $1/Results/Clntab/clntab_noju-unireads.txt $1/Results/Clntab/clntab-unireads.txt | awk '{print $1,$3,$5,$7,$9,$11, ($1+$3+$5+$7+$9+$11), ($13-1), ($1+$3+$5+$7+$9-$11-$13+1), $14}' >> $1/Results/Clntab/clntab_ALL-unireads.txt

#summarize read counts
echo "Reads cross-check: cols: IGH TRA TRB TRD TRG noju sum all sum-all; col9 should equal 0"
echo "IGH TRA TRB TRD TRG noju sum all sumMinusAll sample" > $1/Results/Clntab/clntab_ALL-reads.txt;
paste $1/Results/Clntab/clntab_IGH-reads.txt $1/Results/Clntab/clntab_TRA-reads.txt $1/Results/Clntab/clntab_TRB-reads.txt $1/Results/Clntab/clntab_TRD-reads.txt $1/Results/Clntab/clntab_TRG-reads.txt $1/Results/Clntab/clntab_noju-reads.txt $1/Results/Clntab/clntab-reads.txt | awk '{print $1,$3,$5,$7,$9,$11, ($1+$3+$5+$7+$9+$11), ($11), ($1+$3+$5+$7+$9+$11-$13), $14}' 
paste $1/Results/Clntab/clntab_IGH-reads.txt $1/Results/Clntab/clntab_TRA-reads.txt $1/Results/Clntab/clntab_TRB-reads.txt $1/Results/Clntab/clntab_TRD-reads.txt $1/Results/Clntab/clntab_TRG-reads.txt $1/Results/Clntab/clntab_noju-reads.txt $1/Results/Clntab/clntab-reads.txt | awk '{print $1,$3,$5,$7,$9,$11, ($1+$3+$5+$7+$9+$11), ($11), ($1+$3+$5+$7+$9+$11-$13), $14}' >> $1/Results/Clntab/clntab_ALL-reads.txt
